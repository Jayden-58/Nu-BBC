...
-- A: I will create table with a collum for every skill, as well as a fourign key for the employees table
...
FOREIGN KEY(employee_id) REFERENCES employees_categories(employee_id);
